...
def save(e1,e2,e3,e4):
    ...
    try:
        c.execute("INSERT INTO student_marks (rollno,name,sub1,sub2) VALUES (%s,%s,%s,%s)",(rno,name,sub1,sub2))
        cn.commit()
        ...
        tkinter.messagebox.showerror(title="Error",message="Error saving marks: {}".format(e))
def marks_window():
    w1=gui.Toplevel(w)
    w1.geometry("300x200")
